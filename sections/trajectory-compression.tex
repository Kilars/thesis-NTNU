...
\begin{figure}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \draw[thick, blue, -, opacity=0.7] ($(pic cs:start1) + (0,7.45)$) -- ($(pic cs:end1) + (0,7.45)$);
        \draw[thick, blue, -, opacity=0.7] ($(pic cs:end1) + (0,7.45)$) -- ($(pic cs:end2) + (0,7.45)$);
        \draw[thick, blue, -, opacity=0.7] ($(pic cs:end2) + (0,7.45)$) -- ($(pic cs:end3) + (-0.25,7.45)$);
        \draw[thick, blue, -, opacity=0.7] ($(pic cs:end3) + (-0.25,7.45)$) -- ($(pic cs:end4) + (-0.25,7.45)$);
    \end{tikzpicture}
\end{figure}
